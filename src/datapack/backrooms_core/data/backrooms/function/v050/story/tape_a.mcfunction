...
scoreboard players set @s br_tape_a 1
...
title @s title {text:'FIELD RECORDER 04/19',color:'dark_aqua',bold:true}
tellraw @s {text:'The room had set five plates before we arrived. There were only four of us.',color:'gray',italic:true}
