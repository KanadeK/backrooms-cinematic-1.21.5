...
scoreboard players set @s br_tape_d 1
...
title @s title {text:'FIELD RECORDER 15/19',color:'dark_aqua',bold:true}
tellraw @s {text:'This apartment belongs to no employee. Every family photograph contains the same yellow corridor.',color:'gray',italic:true}
