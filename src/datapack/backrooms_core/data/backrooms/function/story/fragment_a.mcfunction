scoreboard players set @s br_frag_a 1
...
title @s title {text:'Fragment 01/03',color:'aqua',bold:true}
tellraw @s [{text:'SURVEY LOG: The fluorescent cycle repeats every forty-seven seconds. We are walking in circles.',color:'gray',italic:true}]
