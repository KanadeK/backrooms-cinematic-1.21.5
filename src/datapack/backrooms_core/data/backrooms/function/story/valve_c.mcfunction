scoreboard players set @s br_valve_c 1
...
title @s title {text:'VALVE C CLOSED',color:'gold',bold:true}
title @s subtitle {text:'Pressure normalized. The final passage is stable.',color:'gray'}
